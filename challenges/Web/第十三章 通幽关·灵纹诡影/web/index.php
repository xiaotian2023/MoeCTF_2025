...
<body>
    ...
    <div class="container">
        <div class="header">
            <h1>引魂玉·通幽关</h1>
            <p class="subtitle">灵纹绘真，破障通幽</p>
        </div>
        
        <div class="challenge-container">
            <div class="challenge-title">灵纹上传之规</div>
            
            <div class="rules">
                <h3>通幽关规则</h3>
                <ul>
                    <li>仅受仙灵之气浸润的<span class="highlight">「云纹图」</span>可修复玉魄核心（建议扩展名：.jpg）</li>
            ...
            <form class="upload-form" action="upload.php" method="POST" enctype="multipart/form-data" id="spiritUploadForm">
                <div class="form-group">
                    <label for="spiritPattern">请选择灵纹图</label>
                    <div class="file-input">
                        <input type="file" name="spiritPattern" id="spiritPattern" accept=".jpg" required>
                ...
                <button type="submit" class="upload-btn">上传灵纹</button>
            </form>
        </div>
    ...
    <script>
        // 文件选择显示
        const fileInput = document.getElementById('spiritPattern');
